...
import static examples.ecs.movement.Model.boxBuilder;
...
public enum Patterns
{
    ...
    private static void swing(final int layerCount, final Query4<Collider2D, Rectangle, Position, IsFree> query)
    {
        ...
        final List<Row4<Collider2D, Rectangle, Position, IsFree>> list =
    ...
    private static void steps(final int layerCount, final Query4<Collider2D, Rectangle, Position, IsFree> query)
    {
        final int decreaseAmount = (layerCount + 1) * 5 * SquareSize;
